                ...
                <span style="font-size:11px;">Пациент&nbsp;</span><span style="font-size:11px;">(ФИО)</span><span
                    ...
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri",sans-serif;'>
                        <span style="font-size:11px;">
                            ...
                            <strong>
                                <input type="checkbox" {{ strtolower(trim($acs->hospitalization_channels)) == 'скорая' ? 'checked' : '' }} value="скорая"> скорая,
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <input type="checkbox" {{ strtolower(trim($acs->hospitalization_channels)) == 'самотек' ? 'checked' : '' }} value="самотек"> самотек,
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <input type="checkbox" {{ strtolower(trim($acs->hospitalization_channels)) == 'направление' ? 'checked' : '' }} value="направление"> направление
                            </strong>
                        </span>
                    </p>
            <p
                style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri",sans-serif;'>
                <span style="font-size:11px;">Исход лечения: <strong>□ выписан, &nbsp; &nbsp; &nbsp;&nbsp;□ летальный
                        исход, &nbsp;□ выписан в тяжелом состоянии</strong></span></p>
            <p
                style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri",sans-serif;'>
                <span style="font-size:11px;">Исход</span><span style="font-size:11px;">:</span><span
                    style="font-size:11px;">&nbsp;</span><strong><span
                        style="font-size:11px;">□&nbsp;</span></strong><strong><span style="font-size:11px;">ОИМ
                        с&nbsp;</span></strong><strong><span style="font-size:11px;">Q</span></strong><strong><span
                        style="font-size:11px;">&nbsp;</span></strong><strong><span style="font-size:11px;">&nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;□ ОИМ
                        без&nbsp;</span></strong><strong><span style="font-size:11px;">Q</span></strong><strong><span
                        style="font-size:11px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;□ прогрессирующая
                        стенокардия</span></strong></p>
            <p
                style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri",sans-serif;'>
                <span style="font-size:11px;">Срок ангинального приступа при поступлении: <strong>□ до 6 ч.&nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;□ 6-12 ч.&nbsp; &nbsp;&nbsp;□ позже 12 ч.</strong></span></p>
            <div
                ...
                <div style="border: 1px solid #000; padding: 5px;">
                    <p
                        style='margin-top:0cm;margin-right:0cm;margin-bottom:.0001pt;margin-left:0cm;line-height:normal;font-size:15px;font-family:"Calibri",sans-serif;background:#F2F2F2;border:none;padding:0cm;'>
                        <span style="font-size:11px;">Показана&nbsp;</span><strong><span
                                style="font-size:11px;">экстренная</span></strong><span
                            style="font-size:11px;">&nbsp;</span><span style="font-size:11px;">ЧКВ/инвазивная
                            ангиография:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <p
                ...
                <span style="font-size:11px;">Если&nbsp;</span><span style="font-size:11px;">не проведена
                    ЧКВ</span><span style="font-size:11px;">, отметьте причину: <strong>□ медицинские противопоказания,
                        ...
                        расходных материалов, □ отказ больного.</strong></span></p>
            <div
                style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;border:solid windowtext 1.0pt;padding:1.0pt 4.0pt 1.0pt 4.0pt;background:#F2F2F2;'>
                <div style="border: 1px solid #000; padding: 5px;">
                    <p
                    ...
                    <p
                        ...
                        <span style="font-size:11px;">Если &laquo;НЕТ&raquo;, отметьте причину: <strong>□ медицинские
                                противопоказания, □ отсутствие препарата, □ отказ больного.</strong></span></p>
                </div>
            </div>
            <p
                ...
                <strong><span style="font-size:11px;">Во время госпитализации больному (-ой):</span></strong></p>
            <div
