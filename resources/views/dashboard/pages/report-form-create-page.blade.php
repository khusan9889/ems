    ...
    <x-panel title="Форма отчета">
        ...
        <form method="POST" action="{{ route('form.update',['id'=>$week->id]) }}">
            ...
            <table class="table table-responsive borderless">
                <thead>
                <tr>
                    <th scope="col-1" class="vertical-align">Филиал номи</th>
                ...
                <tbody>
                <tr>
                    <th class="text-nowrap" scope="col-1">Филиал номи</th>
            ...
            <div class="m-5">
                <div class="row mb-3">
                    <div class="col-2">
                        ...
                        <input type="number" min="0" class="form-control" name="ambulance_03"
                               value="{{$week->ambulance_03}}" placeholder="03-тез ёрдам">
                    </div>
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_03"
                    ...
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_arrived_himself"
                               value="{{$week->children_arrived_himself}}" placeholder="Жумладан болалар">
                    </div>
                    <div class="col-2">
                        <label>Йулланма билан келган</label>
                        <input type="number" min="0" class="form-control" name="came_ticket"
                               value="{{$week->came_ticket}}" placeholder="Йулланма билан келган">
                    </div>
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_came_ticket"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_recumbent"
                    ...
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_operation"
                    ...
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_high_tech_operas"
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_death"
                               value="{{$week->children_death}}" placeholder="Жумладан болалар">
                    </div>
                    <div class="col-2">
                        <label>Амбулатор</label>
                        <input type="number" min="0" class="form-control" name="ambulator" value="{{$week->ambulator}}"
                               placeholder="Амбулатор">
                    </div>
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="children_ambulator"
                               value="{{$week->children_ambulator}}" placeholder="Жумладан болалар">
                    </div>
                    <div class="col-2">
                        <label>Амбулатор операциялар</label>
                        <input type="number" min="0" class="form-control" name="ambulatory_operas"
                               value="{{$week->ambulatory_operas}}" placeholder="Амбулатор операциялар">
                    </div>
                    <div class="col-2">
                        <label>Жумладан болалар</label>
                        <input type="number" min="0" class="form-control" name="including_children"
            ...
            @if($filial_sub_weeks->count() != 0)
                ...
                <table class="table table-responsive borderless ">
                    ...
                    <tr>
                        ...
                        <th scope="col" colspan="3" style="background: olivedrab;text-align:center">шундан, яшил зона оркали
                        <th scope="col" colspan="3" style="background: yellow;text-align:center">шундан, сарик зона оркали</th>
                        <th scope="col" colspan="4" style="background: red;text-align:center">шундан, кизил зона оркали</th>
                    </tr>
                    </thead>
