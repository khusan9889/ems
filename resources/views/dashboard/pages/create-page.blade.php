...
<x-panel title="Создать">
    <form action="{{ route('create-page') }}" method="POST">
        ...
        <div class="form-group">
            <label for="column1"><b>Канал госпитализации</b></label><br>
        ...
        <hr>
        <div class="form-group">
            <label for="column1"><b>Показана <span style="font-weight: 900; background-color: yellow;">экстренная</span> ЧКВ/инвазивная ангиография:</b></label><br>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="column1" id="column1Option1" value="option1">
        ...
        <hr>
        <div class="form-group">
            <label for="column1"><b>Экстренная ЧКВ выполнена <span style="font-weight: 900; background-color: yellow;"> в течении 90мин:</span></b></label><br>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="column1" id="column1Option1" value="option1">
                <label class="form-check-label" for="column1Option1">Да</label>
            </div>
        ...
        <hr>
        <div class="form-group">
            <label for="column1"><b>Показана <span style="font-weight: 900; background-color: yellow;">отсроченная</span> ЧКВ выполнена/инвазивная ангиография:</b></label><br>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="column1" id="column1Option1" value="option1">
                <label class="form-check-label" for="column1Option1">Да</label>
            </div>
        ...
        <div class="form-group">
            <label for="column1"><b>Проведено <span style="font-weight: 900; background-color: yellow;"> ЭКГ </span></b></label><br>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="column1" id="column1Option1" value="option1">
                <label class="form-check-label" for="column1Option1">медицинские противопоказания</label>
            </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="stat_department_full_name" name="stat_department_full_name">
        </div>
