                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <table class="table table-striped table-bordered align-middle">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="treatment_resultOption3">Выписан в тяжелом состоянии/Og’ir axvolda berib yuborilgan</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="final_resultOption1">ОИМ с Q/Q-infarkt</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="final_resultOption2">Оим без Q/Q-siz infarkt</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="final_resultOption3">Прогрессирующая стенокардияи/Progressiv stenokardiya</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Срок ангинального приступа при поступлении/Anginal huruj boshlanishidan to shifoxonaga kelguncha o’tgan vaqt</th>
                                    <td>
                                        <div class="form-check form-check-inline">
                                ...
                                <tr>
                                    <th>Показана экстренная ЧКВ/инвазивная ангиография/Shoshilinch koronarografiyaga ko’rsatma bormi?</th>
                                    <td>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="ctaInvasiveAngiographyOption1">Да/Ha</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="ctaInvasiveAngiographyOption2">Нет/Yo'q</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Экстренная ЧКВ выполнена в течение 90 минут/Shoshilinch koronarografiya 90 daqiqa ichida o’tkasildimi:</th>
                                    <td>
                                        <div class="form-check form-check-inline">
                                ...
                                <tr>
                                    <th>Показана отсроченная ЧКВ выполнена/инвазивная ангиография/Kechiktirilgan koronarografiyaga ko’rsatma bormi:</th>
                                    <td>
                                        <div class="form-check form-check-inline">
                                ...
                                <tr>
                                    <th>Если не проведена ЧКВ, отметьте причину/Koronarografia o’tkazilmagan bo’lsa, sababini belgilang:</th>
                                    <td>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="reasons_not_performing_ctaOption1">медицинские противопоказания/tibbiy qarshi ko’rsatma</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="reasons_not_performing_ctaOption3">отсутствие оборудования/uskuna yoqligi</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="reasons_not_performing_ctaOption5">отсутствие расходных материалов/sarflanuvchi buyumlarning yoqligi</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="not_administering_tltOption1">медицинские противопоказания/tibbiy qarshi ko’rsatma</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                ...
                                <tr>
                                    ...
                                    <th><span><b> * Во время госпитализации больному (-ой)/Shifoxonada bemorga:</b></span> <br>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="ecg_during_hospitalizationOption2">Нет/Yo'q</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Если «Да», то время первого измерения ФВ ЛЖ%/“Ha” bo’lsa, ChQ OF(%)ni ilk bora olchash muddati</th>
                                    <td>
                                        <div class="form-check form-check-inline">
                                ...
                                <tr>
                                    <th>Принимал статины высокой интенсивности/Yuqori intensive statinlarni qabul qildi:</th>
                                    <td>
                                        <div class="form-check form-check-inline">
