...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('filial_sub_weeks', function (Blueprint $table) {
            ...
            $table->integer('g_appeal');
            $table->integer('g_sleeping');
            $table->integer('g_ambulator');
            $table->integer('y_appeal');
            $table->integer('y_sleeping');
            $table->integer('y_ambulator');
            $table->integer('r_appeal');
            $table->integer('r_sleeping');
            $table->integer('r_death');
            $table->integer('r_dead');
